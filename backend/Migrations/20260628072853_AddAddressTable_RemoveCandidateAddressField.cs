...
{
    /// <inheritdoc />
    public partial class AddAddressTable_RemoveCandidateAddressField : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_CandidateId_AddressType",
                table: "Addresses",
                columns: new[] { "CandidateId", "AddressType" },
                unique: true);
        }
