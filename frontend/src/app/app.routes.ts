...
export const routes: Routes = [
  ...
  },
  {
    ...
    canActivate: [roleGuard(['Recruiter', 'Admin'])],
    loadComponent: () => import('./features/admin/offer-letter/offer-letter-detail.component').then(m => m.OfferLetterDetailComponent)
  },
  ...
  },
  {
    ...
    canActivate: [roleGuard(['Recruiter', 'Admin'])],
    loadComponent: () => import('./features/admin/recruiter-list/recruiter-list.component').then(m => m.RecruiterListComponent)
  },
  ...
  // Create endpoint is Candidate-only on the backend, so Admin is deliberately excluded here) ----------
  {
    ...
    loadComponent: () => import('./features/skills/candidate-skills.component').then(m => m.CandidateSkillsComponent)
  },
  {
    path: 'experience',
    canActivate: [roleGuard(['Candidate'])],
    loadComponent: () => import('./features/experience/candidate-experience.component').then(m => m.CandidateExperienceComponent)
  },
  {
    path: 'qualifications',
    canActivate: [roleGuard(['Candidate'])],
    loadComponent: () => import('./features/qualifications/candidate-qualifications.component').then(m => m.CandidateQualificationsComponent)
  },
  {
    path: 'documents',
    canActivate: [roleGuard(['Candidate'])],
  ...
  // ---------- Any authenticated role ----------
  {
    path: 'vacancies',
    canActivate: [roleGuard(['Candidate'])],
    loadComponent: () => import('./features/vacancies/vacancies.component').then(m => m.VacanciesComponent)
  },
  {
    path: 'vacancies/:id',
    canActivate: [roleGuard(['Candidate'])],
    loadComponent: () => import('./features/vacancies/vacancy-detail.component').then(m => m.VacancyDetailComponent)
  },
  {
    path: 'dashboard',
